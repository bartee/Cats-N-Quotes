...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'quotes_quote', (
            ...
            ('original_author', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ...
        db.create_table(u'quotes_backgroundimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal(u'quotes', ['BackgroundImage'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'quotes_backgroundimage')
